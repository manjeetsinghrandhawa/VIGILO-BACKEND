...
<p>This OTP is valid for 5 minutes. If you did not request a password reset, please ignore this email — your account will remain secure.</p>
<p>Thank you,<br>The Bushra Sweets Team</p>
            </div>
            <div class="footer">
...
export default async function verifyEmail(name, email, otp) {
